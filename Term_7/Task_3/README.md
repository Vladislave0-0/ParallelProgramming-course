...
Условие зависимости возникает, если существует пара итераций $\Lambda = (\lambda_i,\ \lambda_j)$ и $\Kappa = (\kappa_i,\ \kappa_j)$ такие, что 
$$F(\Lambda) = G(\Kappa).$$
...
Как вычислили выше, для любой найденной зависимости $\Lambda = \Kappa$ получаем:
$$\boxed{D = (0,\ 0)},$$
...
По определению:
$$D = \Lambda -\Kappa = (\lambda_i - \kappa_i,\ \lambda_j - \kappa_j).$$
